...
export default function RegisterScreen({ navigation }) {
  ...
  }, [modalVisible, countdown, name, email, navigation]);
      ...
      >
        ...
        >
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Join the NeuroDetect research suite</Text>
          </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.inputWrapper}>
              <Ionicons name="person" size={18} color={COLORS.darkGray} style={styles.inputIcon} />
              <TextInput
                style={styles.input}
            ...
            <View style={styles.inputWrapper}>
              <Ionicons name="key" size={18} color={COLORS.darkGray} style={styles.inputIcon} />
              <TextInput
                style={styles.input}
            ...
            <TouchableOpacity activeOpacity={0.9} onPress={handleRegister} style={styles.primaryButton}>
              <LinearGradient
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            ...
            <Text style={styles.modalMessage}>
              Signed up successfully. Redirecting to login in {countdown}s.
            </Text>
            <TouchableOpacity
            ...
            >
              <Text style={styles.modalButtonText}>Go now</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
